...
思路一：
	...
	2.主过程，根据能力值要么必须贿赂怪兽，要么可以贿赂，也可以不贿赂
	3.如果改dp，index：0-N，ability：0-所有怪兽能力的累加和，如果每个怪兽能力都很大，比如都是10^8左右，那么ability就会
超过10^8，填完整张表，就会超时
	4.如果怪兽的能力值比较小，比如说100以内，怪兽的数量呢，100个以内，那我知道这即便是在最夸张的情况下，
我的能力也不会超过10000。累加和最大是10000，index的范围是100，这张表就是一个10^6的一张表，如果我能力比较小，
我可以知道我做动态规划有前途，在10^8以内，它能填完

思路二：
	1.当前来到了index号怪兽的面前，花的钱数必须严格等于money，返回能通过的最大能力值。如果花money无法通过，返回-1.
process2(int index, int money)
