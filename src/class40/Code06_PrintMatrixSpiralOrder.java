...
/**
 * 怎么写代码？——举例子
 * 先假设具体好理解的具体数据量把事串明白了再做抽象化，你硬写抽象化是特别困难的。憋抽象化是要出问题的。你除非能力很强。你把数据量假设一个具体的例子，亲近它，
 * 玩明白之后再做抽象化。一上来做抽象化，是要疯掉的，人脑子不是这样的，人脑子抽象化很弱的，我们只能理解具象的事物，你跟我都是凡人都一样的，那种特别牛的人抽象化程度很高，人家不牵扯到这种顾忌
 */
